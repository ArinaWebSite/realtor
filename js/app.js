(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".page-slider")) new core(".page-slider__slider", {
                ...
                pagination: {
                    el: ".controll-swiper__dotts",
                    clickable: true
                },
                on: {}
            });
            if (document.querySelector(".page-recimandation")) new core(".page-recimandation__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
                ...
                spaceBetween: 20,
                navigation: {
                    prevEl: ".page-recimandation-prev",
                    nextEl: ".page-recimandation-next"
                },
                breakpoints: {
                    570: {
                        slidesPerView: 2.6
            ...
            if (document.querySelector(".bestseller")) new core(".bestseller__slider", {
            ...
            if (document.querySelector(".page-mobile__stories")) new core(".page-mobile__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                autoHeight: true,
            ...
            if (document.querySelector(".actualiti")) new core(".actualiti__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                loop: true,
                navigation: {
                    prevEl: ".actualiti-prev",
                    nextEl: ".actualiti-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".places")) new core(".places__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
            ...
            if (document.querySelector(".builder")) new core(".builder__slider", {
            ...
            if (document.querySelector(".podobni")) new core(".actualiti__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
            ...
            if (document.querySelector(".rajony-sliders")) new core(".rajony-sliders__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                loop: true,
                navigation: {
                    prevEl: ".rajony-sliders-prev",
                    nextEl: ".rajony-sliders-next"
                },
                on: {}
            });
        }
 ...
 */
        ...
        if (document.querySelector(".katalog-filer-menu")) {
            let searchSelect = document.querySelector(".options-product__filters");
            let categoriesSearch = document.querySelector(".katalog-filer-menu");
        ...
        function fixedHed() {
            ...
            const containHide = () => header.classList.contains("_header-scroll");
            window.addEventListener("scroll", (() => {
                if (scrollPosition() > lastScroll && !containHide() && scrollPosition() > defaultOffset) header.classList.add("_header-scroll"); else if (scrollPosition() < defaultOffset && containHide()) header.classList.remove("_header-scroll");
                lastScroll = scrollPosition();
            }));
        }
        fixedHed();
        if (document.querySelector(".katalog-filer-menu")) {
            document.querySelector(".columnheader-top__buttons").addEventListener("click", (e => {
                e.target.classList.toggle("btn-aktive");
            }));
            document.querySelector(".columnheader-top__btn").addEventListener("click", (e => {
                e.target.classList.toggle("btn-aktive");
            }));
        }
        ...
        formSubmit();
        if (document.querySelector(".bestseller")) mixitup('[data-ref="container-2"]', {
            load: {
                filter: ".allproduct"
            },
            controls: {
